...
public class RepetitiveStatement {
	...
	public static void main(String[] args) {
		/*
		 * for문 - for(int i = 1; i<=10; i++){ } - 1부터 10까지 1씩 증가하면서 반복
		 */
		...
		/*
		 * while문 - while(조건식){} - 조건식의 결과가 true인 동안 계속해서 반복 - 반복횟수를 알 수 없을때
		 * 사용한다.
		 */
		 ...
		 * 
		 * while(true){ System.out.print("몇단을 출력할까요?(0 : 종료) : "); int dan =
		 * Integer.parseInt(sc.nextLine());
		 * 
		 * if(dan == 0){ System.out.println("종료되었습니다."); break; // 가까운 반복문 하나를
		 * 탈출한다. }
		 * 
